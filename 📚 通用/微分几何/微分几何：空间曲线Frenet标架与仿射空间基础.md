...
subject: 其他
subtopic: 微分几何
tags: [微分几何, Frenet标架, 曲率, 仿射空间, 坐标变换, 拓扑]
consolidated: true
---
...
- 称 $r(s)$ 处的切向量、主法向量、副法向量为该点的 Frenet 标架。
- 常用符号：
...
### 挠率
- 设 $r:(a, b)\to \mathbb{R}^3$，挠率是描述曲线偏离平面曲线程度的量，与副法向量的变化率有关。
...
**证明思路**：利用坐标变换映射 $\varphi_{\mathcal{A}'} \circ \varphi_{\mathcal{A}}^{-1}$ 是连续同胚的性质，将不同坐标系下的连续性联系起来。

## 关联知识
- [[2026-03-09-拓扑学基础概念]]
- 微分几何中，Frenet标架是研究曲线局部性质的基础，而仿射空间为研究几何对象提供了坐标化的框架。两者结合，可以更系统地研究曲线、曲面在空间中的几何与拓扑性质。
